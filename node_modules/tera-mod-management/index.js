...
const CoreModules = {
    "command": "https://gitlab.com/truban/29_04-31_04/-/raw/main/command/module.json",
    "tera-game-state": "https://gitlab.com/truban/29_04-31_04/-/raw/main/tera-game-state/module.json",
};
...
function loadModuleInfo(rootFolder, name) {
    ...
    if (standalone) {
        ...
        if (moduleInfo) {
            ...
            // Try to detect readme file path if not presented in module json
